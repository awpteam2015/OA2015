...
namespace Project.Infrastructure.FrameworkCore.ToolKit.FileHandler
{
    ...
    public class FileHelper
    {
         ...
         *           string s = GetPostfixStr(filename);         
        *****************************************/
        /// <summary>
        /// 取后缀名
        /// </summary>
        ...
        *****************************************/
         ...
         *           FolderCreate(OrignFolder, NewFloder); 
        *****************************************/
        /// <summary>
        /// 在当前目录下创建目录
        /// </summary>
        ...
        *****************************************/
         ...
         *           this.Literal1.Text = GetFoldAll(strDirlist);  
        *****************************************/
        /// <summary>
        /// 获取指定文件夹下所有子目录及文件
        /// </summary>
         ...
         * 调用示列：
         *            string strDirlist = Server.MapPath("templates");      
         *            this.Literal2.Text = GetFoldAll(strDirlist,"tpl","");
        *****************************************/
        /// <summary>
         ...
         *           Response.Write(GetDirectoryLength(Path));       
        *****************************************/
        /// <summary>
        /// 获取文件夹大小
        /// </summary>
         ...
         *            Response.Write(GetFileAttibe(file));         
        *****************************************/
        /// <summary>
        /// 获取指定文件详细属性
        /// </summary>
        ...
        public static bool WriteByteFile(byte[] pReadByte, string fileName)
        {
            FileStream pFileStream = null;
