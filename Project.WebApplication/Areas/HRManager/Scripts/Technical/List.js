...
(function () {
    ...
    pro.Technical.ListPage = pro.Technical.ListPage || {};
    pro.Technical.ListPage = {
      init: function () {
            return {
        ...
        initPage: function () {
            ...
            gridObj.grid({
                url: '/HRManager/Technical/GetList',
                fitColumns: false,
                nowrap: false,
                rownumbers: true, //行号
                singleSelect: true,
         ...
         { field: 'LevNum', title: '等级', width: 100 },
         ...
         { field: 'LastModifierUserCode', title: '修改人', width: 100 },
            ...
            $("#btnAdd").click(function () {
               tabObj.add("/HRManager/Technical/Hd","新增");
            });
            ...
            $("#btnEdit").click(function () {
                ...
                tabObj.add("/HRManager/Technical/Hd?PkId=" + PkId, "编辑" + PkId);
            });
            ...
            $("#btnDel").click(function () {
                ...
                $.messager.confirm("确认操作", "是否确认删除", function (bl) {
                    if (!bl) return;
                    abp.ajax({
                        url: "/HRManager/Technical/Delete?PkId=" + gridObj.getSelectedRow().PkId
                    }).done(
...
$(function () {
    pro.Technical.ListPage.initPage();
});
