...
(function () {
    ...
    pro.Technical.HdPage = pro.Technical.HdPage || {};
    pro.Technical.HdPage = {
        initPage: function () {
            $("#btnAdd").click(function () {
                pro.Technical.HdPage.submit("Add");
            });

            $("#btnEdit").click(function () {
                pro.Technical.HdPage.submit("Edit");
            });
            
             $("#btnClose").click(function () {
                parent.pro.Technical.ListPage.closeTab("");
            });
