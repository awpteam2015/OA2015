...
(function () {
    ...
    pro.EmployeeInfoTechnical.ListPage = pro.EmployeeInfoTechnical.ListPage || {};
    pro.EmployeeInfoTechnical.ListPage = {
        init: function () {
            return {
        ...
        initPage: function () {
         ...
         },
         {
            ...
            $("#btnEdit").click(function () {
                ...
                tabObj.add("/HRManager/EmployeeInfoTechnical/Hd?PkId=" + PkId + "&EmployeeCode=" + EmployeeCode, "调动(" + employeeName + ")");
            });
...
$(function () {
    pro.EmployeeInfoTechnical.ListPage.initPage();
});
