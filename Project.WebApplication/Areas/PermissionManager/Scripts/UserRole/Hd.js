...
(function () {
    ...
    pro.UserRole.HdPage = pro.UserRole.HdPage || {};
    pro.UserRole.HdPage = {
        initPage: function () {
            $("#btnAdd").click(function () {
                pro.UserRole.HdPage.submit("Add");
            });

            $("#btnEdit").click(function () {
                pro.UserRole.HdPage.submit("Edit");
            });
        ...
        submit: function (command) {
            ...
            abp.ajax({
                url: "/PermissionManager/UserRole/" + command,
