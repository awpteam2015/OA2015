        ...
        initPage: function () {
         ...
         { field: 'DepartmentCode', title: '部门代码', width: 100 },
            ...
            $("#btnEdit").click(function () {
                ...
                $.tabExtend.config.url = "/PermissionManager/UserDepartment/Hd?PkId=" + gridObj.getSelectedRow().PkId;
                $.tabExtend.add();
            });
            ...
            $("#btnDel").click(function () {
                ...
                $.messager.confirm("确认操作", "是否确认删除", function (bl) {
                    if (!bl) return;
                    abp.ajax({
                        url: "/PermissionManager/UserDepartment/Delete?PkId=" + gridObj.getSelectedRow().PkId
                    }).done(
