        ...
        initPage: function () {
         ...
         { field: 'Remark', title: '备注', width: 100 },
            ...
            $("#btnEdit").click(function () {
                ...
                $.tabExtend.config.url = "/PermissionManager/Function/Hd?PkId=" + $.datagridExtend.getFunObject("getSelected").PkId;
                $.tabExtend.add();
            });
            ...
            $("#btnDel").click(function () {
                ...
                $.messager.confirm("确认操作", "是否确认删除", function (bl) {
                    if (!bl) return;
                    abp.ajax({
                        url: "/PermissionManager/Function/Delete?PkId=" + $.datagridExtend.getFunObject("getSelected").PkId
                    }).done(
